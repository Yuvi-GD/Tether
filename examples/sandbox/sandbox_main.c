...
void sandbox_init(void) {
    ...
    if (btn_hide != TETHER_INVALID_GUID) tether_bind_event(btn_hide, TETHER_EVENT_CLICK, on_hide_clicked, NULL);
    ...
    if (btn_align != TETHER_INVALID_GUID) tether_bind_event(btn_align, TETHER_EVENT_CLICK, on_align_clicked, NULL);
}
